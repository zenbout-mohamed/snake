...
# La boucle principale du jeu (run) écoute l'entrée de l'utilisateur et met à jour le jeu en conséquence.
...
# L'utilisateur peut redémarrer le jeu en appuyant sur Enter ou quitter en appuyant sur Échap.